...
**ML and GenAI Engineer · Globalspace Technologies** · *Jan 2026 – Present*
- **PatGPT**: agentic planning assistant over 3M+ pharma sales and tender records for forecasting, simulation, and historical analysis, with human review checkpoints and evidence-grounded answers.
- **Budget Automation & Incentive Calculator**: replaced per-rep execution trees with one unified hierarchy model and dynamic scoring engine that scales to thousands of employees.

**Freelance Automation Developer · Propelligence Advisors** · *May 2025 – Jan 2026*
- Automated PR ↔ GSTR-2B reconciliation for 10,000+ invoices using RapidFuzz and Polars, cutting a 5–6 day manual cycle by **>99.9%**. Now part of an audit suite used by 2 CA firms (~20 auditors).
