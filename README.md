...
<p align="left">
  ...
  <a href="https://github.com/KedarDamale/KedarDamale/actions/workflows/build-resume.yml"><img src="https://github.com/KedarDamale/KedarDamale/actions/workflows/build-resume.yml/badge.svg" alt="Resume build"></a>
...
The resume is modular: shared content lives in `resume/content/`, while `resume/variants/` provides role-focused entry points. Tag every submitted version (for example, `resume-v1.0` or `company-role-2026-09`) so the exact application can always be recovered.
